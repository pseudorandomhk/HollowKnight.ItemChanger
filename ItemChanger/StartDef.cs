...
namespace ItemChanger
{
    ...
    public class StartDef
    {
        ...
        private static IEnumerator OnRespawn(On.HeroController.orig_Respawn orig, HeroController self)
        {
            ...
            // GetStateMachineTarget only works on framework 4.5+ :zote:
            ...
            if (e != null && E?.DeclaringType != typeof(HeroController))
            {
                while (e.MoveNext())
                {
                    if (e.Current != null && e.Current.GetType().DeclaringType == typeof(HeroController))
                    {
            ...
            FieldInfo state = fields.FirstOrDefault(f => f.Name.Contains("PC") && f.FieldType == typeof(int));
            ...
            if (self.LocateSpawnPoint() == null)
            {
                yield return new WaitUntil(() => self.LocateSpawnPoint() != null);
            }
